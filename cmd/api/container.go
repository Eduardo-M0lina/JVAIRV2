...
import (
	...
	configs "github.com/angumol/jvairv2/configs"
	commonAuth "github.com/angumol/jvairv2/pkg/common/auth"
	"github.com/angumol/jvairv2/pkg/common/storage"
	ability "github.com/angumol/jvairv2/pkg/domain/ability"
	domainAccount "github.com/angumol/jvairv2/pkg/domain/account"
	domainAlert "github.com/angumol/jvairv2/pkg/domain/alert"
	assignedRole "github.com/angumol/jvairv2/pkg/domain/assigned_role"
	domainAuth "github.com/angumol/jvairv2/pkg/domain/auth"
	customer "github.com/angumol/jvairv2/pkg/domain/customer"
	domainDashboard "github.com/angumol/jvairv2/pkg/domain/dashboard"
	domainEmail "github.com/angumol/jvairv2/pkg/domain/email"
	domainEmailTemplate "github.com/angumol/jvairv2/pkg/domain/email_template"
	...
	jobCategory "github.com/angumol/jvairv2/pkg/domain/job_category"
	domainJobEmail "github.com/angumol/jvairv2/pkg/domain/job_email"
	domainJobEquip "github.com/angumol/jvairv2/pkg/domain/job_equipment"
	jobPriority "github.com/angumol/jvairv2/pkg/domain/job_priority"
	domainJobRate "github.com/angumol/jvairv2/pkg/domain/job_rate"
	domainJobRateStatus "github.com/angumol/jvairv2/pkg/domain/job_rate_status"
	...
	jobStatus "github.com/angumol/jvairv2/pkg/domain/job_status"
	domainJobTask "github.com/angumol/jvairv2/pkg/domain/job_task"
	domainJobVisit "github.com/angumol/jvairv2/pkg/domain/job_visit"
	...
	permission "github.com/angumol/jvairv2/pkg/domain/permission"
	property "github.com/angumol/jvairv2/pkg/domain/property"
	domainPropEquip "github.com/angumol/jvairv2/pkg/domain/property_equipment"
	domainQuote "github.com/angumol/jvairv2/pkg/domain/quote"
	quoteStatus "github.com/angumol/jvairv2/pkg/domain/quote_status"
	role "github.com/angumol/jvairv2/pkg/domain/role"
	domainSearch "github.com/angumol/jvairv2/pkg/domain/search"
	settings "github.com/angumol/jvairv2/pkg/domain/settings"
	domainSMSTemplate "github.com/angumol/jvairv2/pkg/domain/sms_template"
	domainSupervisor "github.com/angumol/jvairv2/pkg/domain/supervisor"
	taskStatus "github.com/angumol/jvairv2/pkg/domain/task_status"
	techJobStatus "github.com/angumol/jvairv2/pkg/domain/technician_job_status"
	user "github.com/angumol/jvairv2/pkg/domain/user"
	domainWarranty "github.com/angumol/jvairv2/pkg/domain/warranty"
	domainWarrantyClaim "github.com/angumol/jvairv2/pkg/domain/warranty_claim"
	warrantyClaimStatus "github.com/angumol/jvairv2/pkg/domain/warranty_claim_status"
	warrantyClaimType "github.com/angumol/jvairv2/pkg/domain/warranty_claim_type"
	domainWarrantyEquip "github.com/angumol/jvairv2/pkg/domain/warranty_equipment"
	warrantyStatus "github.com/angumol/jvairv2/pkg/domain/warranty_status"
	warrantyType "github.com/angumol/jvairv2/pkg/domain/warranty_type"
	workflow "github.com/angumol/jvairv2/pkg/domain/workflow"
	infraEmail "github.com/angumol/jvairv2/pkg/infrastructure/email"
	infraSMS "github.com/angumol/jvairv2/pkg/infrastructure/sms"
	infraStripe "github.com/angumol/jvairv2/pkg/infrastructure/stripe"
	mysql "github.com/angumol/jvairv2/pkg/repository/mysql"
	mysqlAbility "github.com/angumol/jvairv2/pkg/repository/mysql/ability"
	mysqlAlert "github.com/angumol/jvairv2/pkg/repository/mysql/alert"
	mysqlAssignedRole "github.com/angumol/jvairv2/pkg/repository/mysql/assigned_role"
	mysqlCustomer "github.com/angumol/jvairv2/pkg/repository/mysql/customer"
	mysqlDashboard "github.com/angumol/jvairv2/pkg/repository/mysql/dashboard"
	mysqlEmailTemplate "github.com/angumol/jvairv2/pkg/repository/mysql/email_template"
	mysqlFile "github.com/angumol/jvairv2/pkg/repository/mysql/file"
	mysqlInvoice "github.com/angumol/jvairv2/pkg/repository/mysql/invoice"
	mysqlInvoicePayment "github.com/angumol/jvairv2/pkg/repository/mysql/invoice_payment"
	mysqlJob "github.com/angumol/jvairv2/pkg/repository/mysql/job"
	mysqlJobActivityLog "github.com/angumol/jvairv2/pkg/repository/mysql/job_activity_log"
	mysqlJobCategory "github.com/angumol/jvairv2/pkg/repository/mysql/job_category"
	mysqlJobEmail "github.com/angumol/jvairv2/pkg/repository/mysql/job_email"
	mysqlJobEquip "github.com/angumol/jvairv2/pkg/repository/mysql/job_equipment"
	mysqlJobPriority "github.com/angumol/jvairv2/pkg/repository/mysql/job_priority"
	mysqlJobRate "github.com/angumol/jvairv2/pkg/repository/mysql/job_rate"
	mysqlJobRateStatus "github.com/angumol/jvairv2/pkg/repository/mysql/job_rate_status"
	mysqlJobResident "github.com/angumol/jvairv2/pkg/repository/mysql/job_resident"
	mysqlJobSMS "github.com/angumol/jvairv2/pkg/repository/mysql/job_sms"
	mysqlJobStatus "github.com/angumol/jvairv2/pkg/repository/mysql/job_status"
	mysqlJobTask "github.com/angumol/jvairv2/pkg/repository/mysql/job_task"
	mysqlJobVisit "github.com/angumol/jvairv2/pkg/repository/mysql/job_visit"
	mysqlNewDashboard "github.com/angumol/jvairv2/pkg/repository/mysql/new_dashboard"
	mysqlPasswordHistory "github.com/angumol/jvairv2/pkg/repository/mysql/password_history"
	mysqlPasswordReset "github.com/angumol/jvairv2/pkg/repository/mysql/password_reset"
	mysqlPayroll "github.com/angumol/jvairv2/pkg/repository/mysql/payroll"
	mysqlPermission "github.com/angumol/jvairv2/pkg/repository/mysql/permission"
	mysqlProperty "github.com/angumol/jvairv2/pkg/repository/mysql/property"
	mysqlPropEquip "github.com/angumol/jvairv2/pkg/repository/mysql/property_equipment"
	mysqlQuote "github.com/angumol/jvairv2/pkg/repository/mysql/quote"
	mysqlQuoteStatus "github.com/angumol/jvairv2/pkg/repository/mysql/quote_status"
	mysqlRole "github.com/angumol/jvairv2/pkg/repository/mysql/role"
	mysqlSearch "github.com/angumol/jvairv2/pkg/repository/mysql/search"
	mysqlSettings "github.com/angumol/jvairv2/pkg/repository/mysql/settings"
	mysqlSMSTemplate "github.com/angumol/jvairv2/pkg/repository/mysql/sms_template"
	mysqlSupervisor "github.com/angumol/jvairv2/pkg/repository/mysql/supervisor"
	mysqlTaskStatus "github.com/angumol/jvairv2/pkg/repository/mysql/task_status"
	mysqlTechJobStatus "github.com/angumol/jvairv2/pkg/repository/mysql/technician_job_status"
	mysqlUser "github.com/angumol/jvairv2/pkg/repository/mysql/user"
	mysqlWarranty "github.com/angumol/jvairv2/pkg/repository/mysql/warranty"
	mysqlWarrantyClaim "github.com/angumol/jvairv2/pkg/repository/mysql/warranty_claim"
	mysqlWarrantyClaimStatus "github.com/angumol/jvairv2/pkg/repository/mysql/warranty_claim_status"
	mysqlWarrantyClaimType "github.com/angumol/jvairv2/pkg/repository/mysql/warranty_claim_type"
	mysqlWarrantyEquip "github.com/angumol/jvairv2/pkg/repository/mysql/warranty_equipment"
	mysqlWarrantyStatus "github.com/angumol/jvairv2/pkg/repository/mysql/warranty_status"
	mysqlWarrantyType "github.com/angumol/jvairv2/pkg/repository/mysql/warranty_type"
	mysqlWorkflow "github.com/angumol/jvairv2/pkg/repository/mysql/workflow"
	handler "github.com/angumol/jvairv2/pkg/rest/handler"
	abilityHandler "github.com/angumol/jvairv2/pkg/rest/handler/ability"
	accountHandler "github.com/angumol/jvairv2/pkg/rest/handler/account"
	alertHandler "github.com/angumol/jvairv2/pkg/rest/handler/alert"
	...
	dashboardHandler "github.com/angumol/jvairv2/pkg/rest/handler/dashboard"
	emailTemplateHandler "github.com/angumol/jvairv2/pkg/rest/handler/email_template"
	invoiceHandler "github.com/angumol/jvairv2/pkg/rest/handler/invoice"
	invoicePaymentHandler "github.com/angumol/jvairv2/pkg/rest/handler/invoice_payment"
	jobHandler "github.com/angumol/jvairv2/pkg/rest/handler/job"
	jobActivityLogHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_activity_log"
	jobCategoryHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_category"
	jobEmailHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_email"
	jobEquipHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_equipment"
	jobPriorityHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_priority"
	jobRateHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_rate"
	jobRateStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_rate_status"
	jobResidentHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_resident"
	jobSMSHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_sms"
	jobStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_status"
	jobTaskHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_task"
	jobVisitHandler "github.com/angumol/jvairv2/pkg/rest/handler/job_visit"
	newDashboardHandler "github.com/angumol/jvairv2/pkg/rest/handler/new_dashboard"
	payrollHandler "github.com/angumol/jvairv2/pkg/rest/handler/payroll"
	...
	propEquipHandler "github.com/angumol/jvairv2/pkg/rest/handler/property_equipment"
	quoteHandler "github.com/angumol/jvairv2/pkg/rest/handler/quote"
	quoteStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/quote_status"
	roleHandler "github.com/angumol/jvairv2/pkg/rest/handler/role"
	searchHandler "github.com/angumol/jvairv2/pkg/rest/handler/search"
	settingsHandler "github.com/angumol/jvairv2/pkg/rest/handler/settings"
	smsTemplateHandler "github.com/angumol/jvairv2/pkg/rest/handler/sms_template"
	stripeHandler "github.com/angumol/jvairv2/pkg/rest/handler/stripe"
	supervisorHandler "github.com/angumol/jvairv2/pkg/rest/handler/supervisor"
	taskStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/task_status"
	techJobStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/technician_job_status"
	userHandler "github.com/angumol/jvairv2/pkg/rest/handler/user"
	warrantyHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty"
	warrantyClaimHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty_claim"
	warrantyClaimStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty_claim_status"
	warrantyClaimTypeHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty_claim_type"
	warrantyEquipHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty_equipment"
	warrantyStatusHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty_status"
	warrantyTypeHandler "github.com/angumol/jvairv2/pkg/rest/handler/warranty_type"
	workflowHandler "github.com/angumol/jvairv2/pkg/rest/handler/workflow"
	middleware "github.com/angumol/jvairv2/pkg/rest/middleware"
	router "github.com/angumol/jvairv2/pkg/rest/router"
)
